...
SECRET_KEY = os.environ.setdefault('Django_secret_key', 'sl_project.settings.local')
...
ROOT_URLCONF = 'sl_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')], ## added by SL for templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sl_project.wsgi.application'
